 ...
 */
@Named
public class GaugeService implements Serializable {
    
    @Inject
    private DatabaseManager dbm;
    
    /**
     * Insert gauge metrics from map.
     * @param value histogram metric attributes.
     */
    public void insertMetric(Map<String, Object> value) {
        dbm.getCollection(MetricType.GAUGE.getCollectionName()).insertOne(new Document(value));
    }
    ...
    public List<GaugeDTO> retrieveMetrics(long fromTime, long toTime, String key) {
        ...
        //exec query
        MongoCursor<Document> result = dbm.getCollection(MetricType.GAUGE.getCollectionName())
    ...
    public List<GaugeDTO> retrieveSumMetrics(long fromTime, long toTime, String key) {
        ...
        //exec query
        MongoCursor<Document> result = dbm.getCollection(MetricType.GAUGE.getCollectionName()).aggregate(params).iterator();
