 ...
 */
@Named
public class HistogramService implements Serializable {
    ...
    public void insertMetric(Map<String, Object> value) {
        dbm.getCollection(MetricType.HISTOGRAM.getCollectionName()).insertOne(new Document(value));
    }
    ...
    public List<HistogramDTO> retrieveMetrics(long fromTime, long toTime, String key) {
        ...
        //exec query
        MongoCursor<Document> result = dbm.getCollection(MetricType.HISTOGRAM.getCollectionName())
